...
/**
 * Accepts a connection from a client and returns the client socket file descriptor.
 *
 ...
 *
 * @param server_p - a pointer to a `server_t` struct
 * @param client_socket_p - a pointer to an integer that will hold the client socket file descriptor
 */
